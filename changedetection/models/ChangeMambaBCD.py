...
from changedetection.models.Mamba_backbone import Backbone_VSSM, Backbone_VSSM1
...
class UpPixelShuffle(nn.Module):
    def __init__(self, in_channels, out_channels, upscale_factor=2):
        ...
        self.act  = nn.SiLU()   # 也可以换成 ReLU/GELU
...
class ChangeMambaBCD(nn.Module):
    def __init__(self, pretrained, **kwargs):
        ...
        #self.encoder1 = Backbone_VSSM(out_indices=(0, 1, 2, 3), pretrained=pretrained, **kwargs)
