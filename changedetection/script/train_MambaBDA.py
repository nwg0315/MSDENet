import sys
sys.path.append('/home/DSJ29/Desktop/MambaCD')
...
def main():
    ...
    parser.add_argument('--cfg', type=str, default='/home/DSJ29/Desktop/MambaCD/changedetection/configs/vssm1/vssm_base_224.yaml')
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('--pretrained_weight_path',default='/home/DSJ29/Desktop/MambaCD/ManbaCD/pretrained_weight/MambaBCD_Tiny_SYSU_F1_0.8316.pth', type=str)

    parser.add_argument('--dataset', type=str, default='xBD')
    parser.add_argument('--type', type=str, default='train')
    parser.add_argument('--train_dataset_path', type=str, default='dataset/tinyperson/Dataset/train')
    parser.add_argument('--train_data_list_path', type=str, default='/home/DSJ29/Desktop/MambaCD/dataset/tinyperson/Dataset/test.txt')
    parser.add_argument('--test_dataset_path', type=str, default='dataset/tinyperson/Dataset/test')
    parser.add_argument('--test_data_list_path', type=str, default='/home/DSJ29/Desktop/MambaCD/dataset/tinyperson/Dataset/train.txt')
